...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/basisgen-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15458&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/basisgen-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `basisgen` can be installed with:

```
conda install basisgen
```

It is possible to list all of the versions of `basisgen` available on your platform with:
